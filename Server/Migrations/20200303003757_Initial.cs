        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDMProduct = table.Column<bool>(nullable: false),
                    IsCoupon = table.Column<bool>(nullable: false),
                    CouponCode = table.Column<string>(nullable: true),
                    DealDomain = table.Column<string>(nullable: true),
                    Status = table.Column<string>(nullable: true),
                    DealTrailer = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealRating", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealRating_Deals_DealId",
                        column: x => x.DealId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealsCategories", x => new { x.DealId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_DealsCategories_DealCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "DealCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DealsCategories_Deals_DealId",
                        column: x => x.DealId,
                        principalTable: "Deals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealRating_DealId",
                table: "DealRating",
                column: "DealId");

            migrationBuilder.CreateIndex(
                name: "IX_DealsCategories_CategoryId",
                table: "DealsCategories",
                column: "CategoryId");
        }
